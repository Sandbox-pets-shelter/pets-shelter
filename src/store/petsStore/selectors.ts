...
export const selectStoriesCurrentPage = (state: IPetStore) => state.petsReducer.currentPage;
export const selectStoriesTotalPages = (state: IPetStore) => state.petsReducer.totalPage;
