...
// import { goToPrevious } from '../../sliderTwo'
// import { goToNext } from '../../sliderTwo'
    ...
    return (
          ...
          <div key={item.key} className={s.stories__subcontainer}>
              ...
              <div className={s.stories__subcontainer__info}>
                <div className={s.stories__subcontainer__views} onClick={handleShareButton}>
                  ...
                  <div className={s.stories__subcontainer__views__share} onClick={handleShareButton}>{item.share}
                    <ShareIcon className={s.stories__subcontainer__views__share__img}/>{styles.share}</div>
              </div>
              ...
              <div className={s.stories__subcontainer__icon}>
                <div className={s.stories__subcontainer__arrow}/>
                  {/* <ArrowleftIcon className={s.stories__subcontainer__arrow__left} onClick= {handleShareButton}/> */}
                  {/* <ArrowrightIcon className={s.stories__subcontainer__arrow__right} onClick= {handleShareButton}/> */}
